...
import { FeaturesSectionDemo } from "@/components/Globe"
  ...
  const tabs = [
    {
      ...
      value: "product",
      content: (
        <div className="w-full overflow-auto relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-b from-amber-100 to-amber-100">
          <p>Product Tab</p>
          <FeaturesSectionDemo />
        </div>
      ),
