...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-orange-100 hover:bg-orange-300 border border-transparent dark:border-white/[0.2] group-hover:border-gray-100 relative z-20",
        className,
      )}
    >
